...
void DebugOverlayBrowser::update_app() {
    ...
    set_info("app_info", debug_info.str());
}

void DebugOverlayBrowser::update_misc() {
    std::stringstream debug_info;
    debug_info << "Network addresses:\n";
    ...
    set_info("misc_info", debug_info.str());
}

void DebugOverlayBrowser::update_window() {
    std::stringstream debug_info;
    debug_info << "Window:\n";
    debug_info << "Display backend: " << displayBackendToString(g_platform.display) << "\n";
    debug_info << "Display names: " << MPV_PROPERTY("display-names") << "\n";
    ...
    set_info("window_info", debug_info.str());
}

void DebugOverlayBrowser::update_video() {
    ...
    set_info("video_info", video_info.str());
}

void DebugOverlayBrowser::set_info(const std::string& id, const std::string& info) {
    layer_->execJs("window.set_info(" + qoute_string(id) + "," + qoute_string(info) + ");");
}
